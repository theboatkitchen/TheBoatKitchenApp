...
import com.example.demoregister.OrderDetailsInKitchen;
...
public class AdapterOrderInKitchen extends RecyclerView.Adapter<AdapterOrderInKitchen.HolderOrderShop>{

    private Context context;
    public ArrayList<ModelOrderStaff> orderStaffList, filterList;

    public AdapterOrderInKitchen(Context context, ArrayList<ModelOrderStaff> orderStaffList) {

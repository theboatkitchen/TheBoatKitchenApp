...
public class ProfileEditCustomerActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updateprofile_customer);
    ...
    private void updateProfile() {
        ...
        hashMap.put("custName",""+nameS);
        hashMap.put("custAge",""+ageS);
        hashMap.put("custPhone",""+phoneS);
        ...
        ref.child(firebaseAuth.getUid()).updateChildren(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(ProfileEditCustomerActivity.this, "Profile Updated...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //failed to update
                        Toast.makeText(ProfileEditCustomerActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void updateImage(Uri uri) {
        ...
        file.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>(){
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ProfileEditCustomerActivity.this, "Failled!", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds: dataSnapshot.getChildren()){
                            ...
                            String age = ""+ds.child("custAge").getValue();

...
public class MainAdminActivity extends AppCompatActivity {
    ...
    private ImageButton logoutBtn,editProfileBtn, addProductBtn, filterProductBtn, settingBtn, addStaff;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addStaff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainAdminActivity.this, RegisterStaffActivity.class));
            }
        });
        ...
        addProductBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(MainAdminActivity.this, CreateMenu.class));
            }
        });
        ...
        filterOrderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String[] options ={"All", "Pending", "In Progress", "Completed", "Cancelled"};
                //dialog
                AlertDialog.Builder builder = new AlertDialog.Builder(MainAdminActivity.this);
                        ...
                        .setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (which==0){
                                    ...
                                    adapterOrderAdmin.getFilter().filter("");// show all orders
                                }
                                else {
        ...
        FirebaseMessaging.getInstance().subscribeToTopic(Constants.FCM_TOPIC)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        //Toast.makeText(MainAdminActivity.this, "Enable Push Notifications", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    private void loadAllOrders() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterOrderAdmin = new AdapterOrderAdmin(MainAdminActivity.this, orderList);
                //set adapter to recylerview
                orderRv.setAdapter(adapterOrderAdmin);
            }
